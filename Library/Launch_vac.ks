...
Parameter liftoff_heading.
	...
	LOCK STEERING TO HEADING(0, liftoff_heading). // stops all rotation until clear of the tower. This should have been set previously but is done again for redundancy
