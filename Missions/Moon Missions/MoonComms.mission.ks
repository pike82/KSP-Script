...
Function Mission_runModes{
	...
	if runMode["runMode"] = 0.1 { 
		...
		Print "Run mode is:" + runMode["runMode"].
		ff_liftoffclimb() .
		ff_GravityTurnAoA(-1.5,"RCS",20.0, 0.01, 0.15, 0.45, 0.4).
		ff_Coast().
		...
		ff_Hohmann(Minmus, 400000, Ship:BODY, 15).
		Wait 1.
...
Function intParameters {
	...
	//Ship Particualrs
	//////////////////////
	Global sv_maxGeeTarget to 2.5.  //max G force to be experienced
    ...
    Global sv_targetAltitude to 120000. //Desired Orbit Altitude from Sea Level
    Global sv_ClearanceHeight to 400. //Intital Climb to Clear the Tower and start Pitchover Maneuver
    Global sv_anglePitchover to 89. //Final Pitchover angle
