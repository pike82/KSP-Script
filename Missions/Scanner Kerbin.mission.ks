...
Function Mission_runModes{
	...
	if runMode["runMode"] = 0.1 { 
		...
		Print "Run mode is:" + runMode["runMode"].
		ff_liftoffclimb() .
		ff_GravityTurnAoA(-0.6,"boost",1.0, 0.03, 0.15, 0.45, 0.4).
		ff_Coast().
...
Function intParameters {
	...
	///////////////////////
 	Global sv_targetInclination to 75. //Desired Inclination
    Global sv_targetAltitude to 150000. //Desired Orbit Altitude from Sea Level
