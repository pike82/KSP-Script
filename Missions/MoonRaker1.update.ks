...
RUNPATH(gf_DOWNLOAD("0:/Library/","OrbRV"+gv_ext,"OrbRV"+gv_ext)).
...
// DELETEPATH ("1:/" + "Util_Launch"+ gv_ext).
// DELETEPATH ("1:/" + "Launch_atm"+ gv_ext).

Function Mission_runModes{
		
	if runMode["runMode"] = 0.0 { 
		Print "Run mode is:" + runMode["runMode"].
		//ff_user_Node_exec().
		ff_Hohmann("Mun", time:seconds + 300).
