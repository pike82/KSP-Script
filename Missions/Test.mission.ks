...
Set Config:IPU to 500.// this needs to be set based on the maximum number of processes happening at once, usually 500 is enought unless its going to be a very heavy script such as a suicide landing script which will require 1500
...
Function Mission_runModes{
	...
	// else if runMode["runMode"] = 1.3 { 
		// Print "Run mode is:" + runMode["runMode"].
		// Launch["InsertionPEG"](sv_targetAltitude).
		// gf_set_runmode("runMode",1.4).
	// }
...
Function intParameters {
    ...
    Set sv_anglePitchover to 87. //Final Pitchover angle
